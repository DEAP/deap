...
def dent(individual, lambda_ = 0.85):
    """Multiobjective problem Dent. Two-objective problem with a "dent".
    *individual* has two attributes that take values in [-1.5, 1.5].
    From: Schuetze, O., Laumanns, M., Tantar, E., Coello, C. a C., & Talbi, E.-G. (2010).
