...
class OnePlusLambdaStrategy(object):
    """
...
class MultiObjectiveStrategy(object):
...
class ActiveOnePlusLambdaStrategy(object):
    ...
    def _integer_mutation(self):
        ...
        for i, j in zip(range(self.lambda_), itertools.cycle(self.i_I_R)):
