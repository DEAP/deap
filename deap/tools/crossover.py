...
def cxOnePoint(ind1, ind2):
    ...
    This function uses the :func:`~numpy.random.randint` function from the
    python base :mod:`random` module.
    """
    size = min(len(ind1), len(ind2))
    cxpoint = numpy.random.randint(1, size - 1)
...
def cxTwoPoint(ind1, ind2):
    ...
    This function uses the :func:`~numpy.random.randint` function from the Python
    base :mod:`random` module.
    """
    size = min(len(ind1), len(ind2))
    cxpoint1 = numpy.random.randint(1, size)
    cxpoint2 = numpy.random.randint(1, size - 1)
...
def cxPartialyMatched(ind1, ind2):
    ...
    This function uses the :func:`~numpy.random.randint` function from the python base
    :mod:`random` module.
    ...
    cxpoint1 = numpy.random.randint(0, size)
    cxpoint2 = numpy.random.randint(0, size - 1)
    if cxpoint2 >= cxpoint1:
        cxpoint2 += 1
    else: # Swap the two cx points
        cxpoint1, cxpoint2 = cxpoint2, cxpoint1
...
def cxUniformPartialyMatched(ind1, ind2, indpb):
    ...
    This function uses the :func:`~numpy.random.random` and :func:`~numpy.random.randint`
...
def cxOrdered(ind1, ind2):
    ...
    """
    size = min(len(ind1), len(ind2))
    a, b = numpy.random.choice(xrange(size), 2)
    if a > b:
        a, b = b, a
...
def cxBlend(ind1, ind2, alpha):
    ...
    for i, (x1, x2) in enumerate(zip(ind1, ind2)):
        gamma = (1. + 2. * alpha) * numpy.random.random() - alpha
...
def cxMessyOnePoint(ind1, ind2):
    ...
    :mod:`random` module.
    """
    cxpoint1 = numpy.random.randint(0, len(ind1))
    cxpoint2 = numpy.random.randint(0, len(ind2))
...
def cxESTwoPoint(ind1, ind2):
    ...
    pt1 = numpy.random.randint(1, size)
    pt2 = numpy.random.randint(1, size - 1)
    if pt2 >= pt1:
        pt2 += 1
    else: # Swap the two cx points
        pt1, pt2 = pt2, pt1
