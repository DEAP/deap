...
tools.register('expr_init', gp.generate_ramped_typed, type="bool", pset=pset, min=1, max=2)
...
tools.register('mate', toolbox.onePtTreeTypedCx)
tools.register('expr_mut', gp.generate_full_typed, pset=pset, min=0, max=2)
tools.register('mutate', toolbox.uniformTreetypedMut, expr=tools.expr_mut)
